<template>
  ...
  <div class="relative h-screen container px-5 pt-28 pb-20 md:py-24">
    ...
    <div class="pt-2 md:pt-6 max-w-1/2 max-h-1/2">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 class="text-gray-900 text-xl md:text-3xl title-font font-medium mb-1">{{Product.title}}</h1>
        <div class="flex mb-4">
          ...
          <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2s">
            ...
            <a class="text-gray-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9Notify-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>
              </svg>
            </a>
          </span>
        </div>
  ...
  <section v-else>
    <img class="block w-full h-full" src="../assets/loading.gif" alt="">
  </section>
  </div>
</template>
